...
/**
 * A nonfuctional placeholder codec. This is the default for all annotations that let you specify a codec. If it is
 * present, then we should use the default codec.
 */
public class DefaultCodec extends DynamoCodec<Void> {
